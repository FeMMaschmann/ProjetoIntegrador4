<?php
	...
	if (isset($_GET['erro']) && $_GET['erro'] == 2) {
		$erro = "Atenção! usuário ou senha inválidos!";
	}
?>
<!DOCTYPE html>
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container">
			...
			<form action="controllers/logarDAO.php" method="POST" class="login">
				<label for="usuario_login">Usuário:
				...
				<input type="submit" name="submit" class="submit" id="submit_login" value="Logar">
			</form>
		</div>
		<?php
