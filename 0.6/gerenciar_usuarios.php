        ...
        while($linha = $read->fetch_assoc()){
          ...
          $data = date('d/m/Y H:i:s',strtotime($data));
            ...
            <tr>
              ...
              <td><a href='editar_usuario.php?id=$id'><img title='Imagem de editar' alt='Imagem de editar' src='img/edit.png'></a></td>";
              if ($tipo == 'roote') {
                echo "<td>Não</td>";
              }else {
                echo "<td><a onclick='return confirm(\"Você tem certeza que deseja excluir o usuário?\")' href='controllers/excluir_usuarioDAO.php?id=$id'><img title='Imagem de excluir' alt='Imagem de excluir' src='img/delete.png'></a></td>";
              }
              echo "
            </tr>";
        }
