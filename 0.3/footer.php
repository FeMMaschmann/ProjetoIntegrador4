  ...
  <section class="rodape">
    <div class="flex">
      <div class="sect">
        ...
        <p>O site inteiro foi feito de fã para fã e até mesmo para aqueles que não são fãs. Você encontrará diversas imagens, explicações sobre o mundo de Temerant.</p><p>Caso tenha alguma sugestão faça uma conta e contate-nos ou mande um email para:<br>Admin@root.com</p>
      </div>
      <div class="sect">
